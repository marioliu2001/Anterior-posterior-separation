...
public class Generator {
    public static void main(String[] args) {
        ...
        //定义entity路径
        String entityPath = parent + "/entity/src/java/com/powernode/entity";
        //其他项目路径
        ...
        dsc.setDriverName("com.jdbc.mysql.Driver");
        dsc.setUrl("jdbc:mysql://192.167.175.131:3306/test?useUnicode=true&characterEncoding=utf8");
